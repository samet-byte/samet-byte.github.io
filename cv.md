...
![Samet Bayat](https://sdk.bitmoji.com/render/panel/20048676-100025018093_13-s5-v1.png?transparent=1&palette=1&scale=1)
...
- [LinkedIn](https://www.linkedin.com/in/sametbayat/)
- [GitHub](https://github.com/samet-byte)
- [Blog](https://sametb.com/)
...
- Hoops Insight
  ...
  - Accomplishments:
    ...
    - Processed content data with Python and BeautifulSoup.
  - GitHub:
  - (Repository will be public after evaluating the code quality)
...
- Robot Arm for Agriculture
  - Description: A robot arm project that helps in agriculture. Developed to learn robotics and automation.
...
## Certifications & Courses & Workshops & Programs
...
For fun version of this CV, [click here](https://sametb.com/cv_fun.md)